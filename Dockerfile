...
RUN mkdir -p /opt/letsencrypt/certs
WORKDIR /opt/letsencrypt
ADD get-certs.sh /opt/letsencrypt/get-certs.sh 
RUN chmod +x /opt/letsencrypt/get-certs.sh && chmod 777 /opt/letsencrypt/certs && chown 1001:1001 -R /opt/letsencrypt

USER 1001
VOLUME ['/opt/letsencrypt/certs']
