...
RUN mkdir -p /opt/letsencrypt/work/{certs,logs,work,config} 
WORKDIR /opt/letsencrypt
ADD get-certs.sh /opt/letsencrypt/get-certs.sh 
RUN chmod +x /opt/letsencrypt/get-certs.sh && chmod 777 -R /opt/letsencrypt/work && chown 1001:1001 -R /opt/letsencrypt  
